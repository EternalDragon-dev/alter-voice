#!/usr/bin/env python3
# realtime_optimized.py
# Real-time voice modulator optimized for <100ms latency
import numpy as np
...
def main():
    print("=== Optimized Real-time Voice Modulator ===")
    print("Controls:")
    ...
    print("  q   : Quit")
    print("\nFast pitch shifting in duplex stream")
    print("Optimized: Lower latency with quality preserved")
    print_status()
